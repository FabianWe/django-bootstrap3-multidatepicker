...
"""
Django settings for django_bootstrap3_datepicker project.
...
ROOT_URLCONF = 'django_bootstrap3_datepicker.urls'
...
WSGI_APPLICATION = 'django_bootstrap3_datepicker.wsgi.application'
